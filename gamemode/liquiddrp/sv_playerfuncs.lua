...
util.AddNetworkString( "StartClientTables")
util.AddNetworkString( "ReceiveClientTables")


net.Receive( "StartClientTables" , function( len , ply ) 

     net.Start( "ReceiveClientTables" )
     net.Send( ply ) 

     print(ply:Nick() .. " Tables are initilized!" )
