...
local function PrettyFormatNumberFinalFunc(str)

      return str

end 

function PrettyFormatNumber(n)
    ...
    return (negative and "-" or "") .. PrettyFormatNumberFinalFunc(n)
